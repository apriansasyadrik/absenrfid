...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('walikelas/dashboard') ?>">
        <div class="sidebar-brand-icon rotate-n-15">
            <i class="fas fa-user-tie"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Portal Wali Kelas</div>
    </a>
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item <?= ($this->uri->segment(1) == 'walikelas' && ($this->uri->segment(2) == 'dashboard' || $this->uri->segment(2) == '')) ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('walikelas/dashboard') ?>">
    ...
    <li class="nav-item <?= ($this->uri->segment(2) == 'izin-siswa') ? 'active' : '' ?>">
